...
<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-1.png?raw=true"  height="500px">

- 選自定 / click custom

<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-2.png?raw=true"  height="500px">

- 填寫一個名稱/ write a name
- Webhook網址填入 http://127.0.0.1:[docker設定的port]/?message=Hello+world
- Webhook url : http://127.0.0.1:[docker port]/?message=Hello+world

<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-3.png?raw=true"  height="500px">
...
<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-4.png?raw=true"  height="500px">

-設定message 為 通知內文 / Set message type FULLTEXT

-設定Authorization 為 其他參數 / Set Authorization type OTHER

<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-5.png?raw=true"  height="500px">

-完成後可以點擊發送測試通知  /  send test Notifications after finish setting

<img src="https://github.com/kitten1156/Synology_Line_notify/blob/main/docs/dsm-notify-6.png?raw=true"  height="500px">
